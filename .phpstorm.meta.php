...
'web','api',);
        registerArgumentsSet('routes', 'home','channels.show','channels.create','channels.store',
'channels.edit','channels.update','channels.destroy','channels.messages.store','channels.messages.update',
'channels.messages.destroy','profile.edit','profile.update','profile.destroy',
